...
| Mentor | 鍝嗗暒 A 姊?(Doraemon) | Round blue robot cat, big white eyes, red nose, whiskers, white belly with 4D pocket, golden bell, no ears |
...
| Preset with simplified characters (e.g., four-panel minimalist) | Skip 鈥?prompt descriptions are sufficient |
...
| Skipped | 鈥?| **C**: Prompt file contains all descriptions inline |
...
3. **If still fails**: Fall back to **Strategy C** 鈥?generate WITHOUT `--ref`, with character descriptions embedded in prompt text
...
- 澶ч泟锛欽apanese boy, round glasses, yellow shirt, navy shorts...
- 鍝嗗暒 A 姊︼細Round blue robot cat, white belly, red nose, golden bell...
